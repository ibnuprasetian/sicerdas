...
<body class="font-poppins antialiased bg-gray-100">
        ...
        <nav class="bg-indigo-900 text-white px-4 py-3 shadow-md fixed top-0 left-0 right-0 z-50">
            <div class="container mx-auto flex justify-between items-center">
                <div class="flex items-center space-x-2 animate-wave">
                    <img src="{{ asset('images/LogoSiCerdas.png') }}" alt="Si Cerdas Logo" class="w-10 h-10 mr-1">
                    <img src="{{ asset('images/TextSiCerdas.png') }}" alt="Si Cerdas Text" class="w-28 h-8">
                </div>
                ...
                <div class="hidden md:flex space-x-6 text-lg items-center pt-1">
                    @auth
                        @if(Auth::user()->isStudent())
                            ...
                            <a href="{{ route('quiz.petualangan.map') }}" class="hover:underline">Quiz</a>
                        ...
                        @elseif(Auth::user()->isTeacher())
                            ...
                            <a href="{{ route('teacher.diskusi.index') }}" class="hover:underline">Diskusi Siswa</a>
                            <a href="{{ route('teacher.quiz.index') }}" class="hover:underline">Kelola Quiz</a>
    ...
    @if (request()->routeIs('quiz.petualangan.map') || request()->routeIs('quiz.petualangan.index'))
        <audio id="bg-music" src="{{ asset('audio/petualangan.mp3') }}" loop></audio>
        <script>
