        ...
        <div class="col-md-8 col-lg-7 col-xl-6">
            <div class="card shadow-lg rounded-4 overflow-hidden animate__animated animate__fadeIn">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('teacher.quiz.update', $soal->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="pertanyaan" class="form-control form-control-lg rounded-end" value="{{ $soal->pertanyaan }}" required placeholder="Ketik pertanyaan di sini...">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.1s;">
                            ...
                            <div class="input-group">
                                ...
                                <select name="level" class="form-select form-select-lg rounded-end" required>
                                    <option value="1" {{ $soal->level == 1 ? 'selected' : '' }}>Mudah</option>
                                    <option value="2" {{ $soal->level == 2 ? 'selected' : '' }}>Sedang</option>
                                    <option value="3" {{ $soal->level == 3 ? 'selected' : '' }}>Sulit</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.2s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_a" class="form-control form-control-lg rounded-end" value="{{ $soal->opsi_a }}" required placeholder="Jawaban pilihan A">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.3s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_b" class="form-control form-control-lg rounded-end" value="{{ $soal->opsi_b }}" required placeholder="Jawaban pilihan B">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.4s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_c" class="form-control form-control-lg rounded-end" value="{{ $soal->opsi_c }}" required placeholder="Jawaban pilihan C">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.5s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_d" class="form-control form-control-lg rounded-end" value="{{ $soal->opsi_d }}" required placeholder="Jawaban pilihan D">
                            </div>
                        </div>
