...
<body class="font-sans text-gray-900 antialiased">
    ...
    <nav class="bg-blue-700 text-white py-4 px-8">
        ...
        <div id="mobile-menu" class="hidden md:hidden mt-2">
            <a href="{{ route('login') }}" class="block px-4 py-2 hover:bg-blue-600">Login</a>
            <a href="{{ route('register') }}" class="block px-4 py-2 hover:bg-blue-600">Register</a>
        </div>
    </nav>
    ...
    <section class="flex justify-center items-center min-h-screen bg-blue-50">
        <div class="flex items-center justify-between w-full max-w-screen-lg p-6">
            <div>
                <img src="{{ asset('images/wallpaper.png') }}" alt="Welcome Image" class="w-full h-auto">
            </div>
        </div>
    </section>
