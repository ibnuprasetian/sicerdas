...
<head>
    ...
    <link rel="icon" href="{{ asset('images/LogoSiCerdas.png') }}" type="image/png">
...
<body class="font-sans text-gray-900 antialiased bg-blue-50">
    ...
    <nav class="bg-blue-700 text-white shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <div class="flex items-center space-x-2">
                <img src="{{ asset('images/LogoSiCerdas.png') }}" alt="Si Cerdas Logo" class="w-10 h-10">
                <img src="{{ asset('images/TextSiCerdas.png') }}" alt="Si Cerdas Text" class="h-8">
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-12">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left space-y-6" data-aos="fade-right">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-start justify-center gap-4 mt-6">
                    <a href="{{ route('login') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition shadow">Masuk</a>
                    <a href="{{ route('register') }}" class="bg-white border border-blue-600 text-blue-600 hover:bg-blue-100 font-semibold px-6 py-3 rounded-lg transition shadow">Daftar</a>
                </div>
            </div>

            <!-- Gambar -->
            <div class="w-full lg:w-1/2" data-aos="fade-left">
                <img src="{{ asset('images/wallpaper.png') }}" alt="Welcome Image" class="rounded-xl w-full object-cover shadow-xl max-h-[480px]">
            </div>
        </div>
    </section>
    ...
    <section class="bg-indigo-600 text-white py-16 px-4">
        <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
            ...
            <a href="{{ route('register') }}" class="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-lg shadow hover:bg-indigo-100 transition">
                Daftar Sekarang
            </a>
        </div>
    </section>
    ...
    <footer class="bg-blue-700 text-white py-6 text-center px-4 relative z-10">
        <p>&copy; {{ date('Y') }} Si Cerdas. Semua Hak Dilindungi.</p>
    </footer>
