                ...
                <div class="hidden md:flex space-x-4">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php elseif(Auth::user()->isTeacher()): ?>
                            ...
                            <a href="<?php echo e(route('teacher.diskusi.index')); ?>" class="hover:underline">Forum Diskusi</a>
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-2">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->isStudent()): ?>
                        ...
                        <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 hover:bg-indigo-700">Profile</a>
                    <?php elseif(Auth::user()->isTeacher()): ?>
                        <a href="<?php echo e(route('teacher.dashboard')); ?>"
                            class="block px-4 py-2 hover:bg-indigo-700">Dashboard</a>
                        <a href="" class="block px-4 py-2 hover:bg-indigo-700">Kelola Materi</a>
                        <a href="<?php echo e(route('teacher.users.index')); ?>" class="block px-4 py-2 hover:bg-indigo-700">Kelola
                            User</a>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 hover:bg-indigo-700">Profile</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('logout')); ?>"
...
<?php /**PATH C:\laragon\www\sicerdas\resources\views/layouts/app.blade.php ENDPATH**/ ?>