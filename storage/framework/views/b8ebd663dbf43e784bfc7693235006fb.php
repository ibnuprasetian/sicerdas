<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-2xl shadow-xl px-8 py-10 max-w-7xl mx-auto space-y-10">
        ...
        <div class="text-center">
            <h1 class="text-3xl font-extrabold text-indigo-800 mb-2">Selamat Datang, <?php echo e(Auth::user()->name); ?>!</h1>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sicerdas\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>