                ...
                <div class="row g-4 justify-content-center animate__animated animate__fadeIn">
                    <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 animate__animated animate__slideInUp"
                                        style="animation-delay: <?php echo e(0.15 * $loop->index); ?>s;">
                                        <div
                                            class="card level-card text-center <?php echo e($is_unlocked ? '' : 'locked'); ?> <?php echo e($user->level == $level ? 'current animate__animated animate__pulse animate__infinite infinite' : ''); ?>">
                                            <div class="card-body py-4">
                                                <h5 class="card-title mb-2" style="font-size: 1.2rem;"><?php echo e($icon); ?> Level <?php echo e($level); ?></h5>
                                                <div class="mb-3">
                                                    <?php if($is_done): ?>
                                                ...
                                                <?php if($user->level == $level): ?>
                                                    <a href="<?php echo e(route('quiz.petualangan.index')); ?>"
            ...
            <div id="levelUpPopup" class="popup-wrapper">
                <div class="popup-content text-center bg-white p-5 rounded shadow-lg animate__animated animate__bounceIn">
                    ...
                    <p class="lead mb-4">
                        ...
                        <span class="fw-bold">Level <?php echo e($user->level); ?></span>!
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sicerdas\resources\views/quiz/petualangan_map.blade.php ENDPATH**/ ?>