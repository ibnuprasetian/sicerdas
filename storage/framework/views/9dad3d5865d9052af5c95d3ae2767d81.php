        ...
        <div class="col-md-8 col-lg-7 col-xl-6">
            <div class="card shadow-lg rounded-4 overflow-hidden animate__animated animate__fadeIn">
                <div class="card-header bg-gradient-primary text-white py-4">
                    <h4 class="mb-0 text-center"><i class="bi bi-pencil-square me-2"></i> Edit Soal</h4>
                </div>
                <div class="card-body p-4">
                    <form action="<?php echo e(route('teacher.quiz.update', $soal->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="pertanyaan" class="form-control form-control-lg rounded-end" value="<?php echo e($soal->pertanyaan); ?>" required placeholder="Ketik pertanyaan di sini...">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.1s;">
                            ...
                            <div class="input-group">
                                ...
                                <select name="level" class="form-select form-select-lg rounded-end" required>
                                    <option value="1" <?php echo e($soal->level == 1 ? 'selected' : ''); ?>>Mudah</option>
                                    <option value="2" <?php echo e($soal->level == 2 ? 'selected' : ''); ?>>Sedang</option>
                                    <option value="3" <?php echo e($soal->level == 3 ? 'selected' : ''); ?>>Sulit</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.2s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_a" class="form-control form-control-lg rounded-end" value="<?php echo e($soal->opsi_a); ?>" required placeholder="Jawaban pilihan A">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.3s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_b" class="form-control form-control-lg rounded-end" value="<?php echo e($soal->opsi_b); ?>" required placeholder="Jawaban pilihan B">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.4s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_c" class="form-control form-control-lg rounded-end" value="<?php echo e($soal->opsi_c); ?>" required placeholder="Jawaban pilihan C">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.5s;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="opsi_d" class="form-control form-control-lg rounded-end" value="<?php echo e($soal->opsi_d); ?>" required placeholder="Jawaban pilihan D">
                            </div>
                        </div>
                        ...
                        <div class="mb-3 animate__animated animate__fadeIn" style="animation-delay: 0.6s;">
                            ...
                            <div class="input-group">
                                ...
                                <select name="jawaban_benar" class="form-select form-select-lg rounded-end" required>
                                    <option value="a" <?php echo e($soal->jawaban_benar == 'a' ? 'selected' : ''); ?>>A</option>
                                    <option value="b" <?php echo e($soal->jawaban_benar == 'b' ? 'selected' : ''); ?>>B</option>
                                    <option value="c" <?php echo e($soal->jawaban_benar == 'c' ? 'selected' : ''); ?>>C</option>
                                    <option value="d" <?php echo e($soal->jawaban_benar == 'd' ? 'selected' : ''); ?>>D</option>
                                </select>
                            </div>
                        </div>

                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4 animate__animated animate__fadeIn" style="animation-delay: 0.7s;">
                            <a href="<?php echo e(route('teacher.quiz.index')); ?>" class="btn btn-outline-secondary rounded-pill"><i class="bi bi-arrow-left me-1"></i> Batal</a>
                            <button type="submit" class="btn btn-success rounded-pill"><i class="bi bi-save me-1"></i> Update Soal</button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sicerdas\resources\views/teacher/quiz/edit.blade.php ENDPATH**/ ?>