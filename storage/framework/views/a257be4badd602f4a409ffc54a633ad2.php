<?php $__env->startSection('content'); ?>
    ...
    <h1 class="text-3xl font-extrabold text-indigo-700 mb-6 animate__animated animate__fadeInDown">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
            <a href="<?php echo e(route('teacher.materi.create')); ?>"
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            <?php $__empty_1 = true; $__currentLoopData = $materis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col animate__animated animate__slideInUp" style="animation-delay: <?php echo e(0.15 * $loop->index); ?>s;">
                    <div class="card h-100 shadow-lg rounded-4 border-0 hover-effect">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title fw-bold text-info"><i class="bi bi-journal-bookmark-fill me-2"></i>
                                <?php echo e($materi->judul); ?></h5>
                            <p class="card-text text-muted small"><?php echo e(Str::limit($materi->deskripsi, 80)); ?></p>
                            <?php if($materi->subMateris->isNotEmpty()): ?>
                                <ul class="list-unstyled mt-2 small">
                                    ...
                                    <?php $__currentLoopData = $materi->subMateris->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><i class="bi bi-file-earmark-text-fill me-2 text-secondary"></i> <?php echo e($sub->judul); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($materi->subMateris->count() > 3): ?>
                                        <li class="text-muted fst-italic">+ <?php echo e($materi->subMateris->count() - 3); ?> lainnya</li>
                                    <?php endif; ?>
                                </ul>
                            <?php else: ?>
                            ...
                            <div class="mt-auto d-flex justify-content-end gap-2">
                                <a href="<?php echo e(route('teacher.materi.edit', $materi->id)); ?>"
                                    class="btn btn-sm btn-outline-warning rounded-pill shadow-sm" title="Edit">
                                    <i class="bi bi-pencil-square-fill"></i>
                                </a>
                                <form action="<?php echo e(route('teacher.materi.destroy', $materi->id)); ?>" method="POST"
                                    class="d-inline">
                                    <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-12 animate__animated animate__fadeIn">
                    <div class="alert alert-info rounded-pill shadow-sm" role="alert">
                        ...
                        <a href="<?php echo e(route('teacher.materi.create')); ?>" class="alert-link ms-2">Tambahkan materi baru di
                            sini</a>.
                    </div>
                </div>
            <?php endif; ?>
